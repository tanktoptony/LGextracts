"""
Django settings for liquidgold project.
...
ALLOWED_HOSTS = ['lgextracts.com', 'www.lgextracts.com']
CSRF_TRUSTED_ORIGINS = ['https://lgextracts.com', 'https://www.lgextracts.com']
...
WSGI_APPLICATION = 'liquidgold.wsgi.application'
